...
class TopSellingSubCategoryTable extends TableAbstract
{
    ...
    public function __construct(DataTables $table, UrlGenerator $urlGenerator)
    {
        ...
        parent::setAjaxUrl(route('reports.topSellingSubCategoryData'));
    ...
    public function query()
    {
        ...
        return  collect($topSellingCategories)->sortByDesc('orders')->take(10);
