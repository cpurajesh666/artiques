@if ($productAttributeSets->count() > 0)
    <div class="add-new-product-attribute-wrap">
        ...
        <!-- <a href="{{url('/admin/ecommerce/product-attribute-sets')}}"  data-bs-toggle-text="{{ trans('plugins/ecommerce::products.form.cancel') }}">{{ trans('plugins/ecommerce::products.form.add_new_attributes') }}</a> -->

        <a href="{{url('/admin/ecommerce/product-attribute-sets/create')}}" target="_blank" class="btn-trigger-add-attribute">Add Attributes</a>
                    ...
                    <div class="row">
                        <div class="col-md-4 col-sm-6">
                            <div class="form-group mb-3">
                                <input type="text" class="next-input attribute-set" readonly style="background-color : #d1d1d1; "> </input>
                                <input name=attribute-set[] class="attribute-set-val" hidden disabled>
                            </div>
                        </div>
                        <div class="col-md-4 col-sm-6">
                            <div class="form-group mb-3">
                                <input type="text" class="next-input attribute" readonly style="background-color : #d1d1d1; "></input>
                                <input name=attribute[] hidden class="attribute-val" disabled>
                            </div>
                        </div>
            ...
            <div class="list-product-attribute-wrap-detail">
                <div class="product-attribute-set-item">
                    <div class="row">
                        <div class="col-md-4 col-sm-6">
                            <div class="form-group mb-3">
                                <label class="text-title-field">Attribute</label>
                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="form-group mb-3">
                                <label class="text-title-field">Sub Attribute</label>
                                <div class="product-select-attribute-item-value-wrap">
                                    <select class="next-input product-select-attribute-item-value product-select-attribute-item-value-id-{{ $attributeSetId }}"   data-set-id="{{ $attributeSetId }}">
                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="form-group mb-3">
                                ...
                                <div style="height: 36px;line-height: 33px;vertical-align: middle">
                                      <a href="#" class="btn btn-secondary btn-trigger-add-attribute-item @if ($productAttributeSets->count() < 1) hidden @endif">Attach Attribute</a>
                                </div>
                            </div>
                        </div>
                ...
                @if($existingAttributes && $existingAttributes->count() > 0)
                    @foreach($existingAttributes as $existingAttribute)
                        <div class="product-attribute-set-item">
                            <div class="row">
                                <div class="col-md-4 col-sm-6">
                                    <div class="form-group mb-3">
                                        <input type="text" class="next-input attribute-set" value="{{$existingAttribute->attribute_set}}"
                                        readonly style="background-color : #d1d1d1; "> </input>
                                        <input name=attribute-set[] class="attribute-set-val" value="{{$existingAttribute->attribute_set_id}}" hidden>
                                    </div>
                                </div>
                                <div class="col-md-4 col-sm-6">
                                    <div class="form-group mb-3">
                                        <input type="text" class="next-input attribute" value="{{$existingAttribute->attribute}}"
                                        readonly style="background-color : #d1d1d1; "></input>
                                        <input name=attribute[]  class="attribute-val" value="{{$existingAttribute->attribute_id}}" hidden>
                                    </div>
                                </div>

                                <div class="col-md-4 col-sm-6 product-set-item-delete-action">
                                    <div class="form-group mb-3">
                                        <div style="height: 36px;line-height: 33px;vertical-align: middle">
                                            <a href="#" class="btn btn-danger"><i class="fa fa-trash"></i></a>
                                        </div>
