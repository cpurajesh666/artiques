        ...
        <form wire:submit.prevent="save">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 m-8">
                <div x-data="{
                    ...
                    categoryName: @entangle('categoryName').defer
                }">
                ...
                <div class="mt-4">
                    <span class="text-sm">Existing Image:</span>
                    <img src="{{ asset('storage/' . $product->images[0]) }}" class="mt-2 h-48 w-auto">
                </div>
                <div class="col-span-2">
                    <label class="block font-medium text-sm text-gray-700"
                           class="text-base font-semibold" for="image">{{ __('Update Image') }}</label>
